        ...
        <div className="relative z-10 container mx-auto px-4 py-8 text-center">
          <div className="max-w-4xl mx-auto space-y-8 animate-fade-in">
            <div className="flex flex-col items-center gap-0">
              ...
              />
              <h1 className="text-5xl md:text-7xl font-bold text-white drop-shadow-lg -mt-24 md:-mt-36" style={{ textShadow: '0 0 20px rgba(14, 165, 233, 0.8), 0 0 40px rgba(14, 165, 233, 0.5)' }}>
                ICRA TECHNOLOGIES
              </h1>
            </div>
